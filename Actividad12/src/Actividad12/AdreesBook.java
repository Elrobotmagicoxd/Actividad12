...
public class AdreesBook{
            ...
            try{
                ...
                switch(opc)
                {
                    ...
                    case 4:
                        ...
                        telefono = leer.next();
                        System.out.println("Intruduce el nombre del contacto: ");
                        nombre = leer.next();
    ...
    {
        String inputFilename = "C:\\Users\\Lopez\\IdeaProjects\\Actividad12\\src\\contactos\\input.csv";
        String a [];
        ...
        try {
            ...
            try {
                if (bufferedWriter != null) {
                    ...
                    System.out.println("\nSe han guardado los nuevos cambios");
                }
            } catch (IOException e) {
                System.out.println("IOException catched while closing: " + e.getMessage());
            }
